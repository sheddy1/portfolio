        ...
        <div className="container contact_comp"> 
            ...
            <div className="contact_comp2">
                ...
                <div className="contact_social">
                    ...
                    <a href="#"><img src={whatsapp} className="contact_social_whatsapp" /></a>
                    <a href="#"><img src={instagram} className="contact_social_instagram" /></a>
                    <a href="#"><img src={facebook} className="contact_social_facebook" /></a>
                </div>
            </div>
        </div>
    );
