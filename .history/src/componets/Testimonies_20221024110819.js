...
import right from './photos/right1.png';
import left from './photos/left1.png';
        ...
        <div class="container testimony_comp">
            ...
            <div className="testimony_body">
                <div class="testimony_body_pic">
                    <img src={rqmark} class="testimony_body_pic1"/>
                </div>
                ...
                <div class="testimony_body_writeup">
                    ...
                    <div class="testimony_body_writeup5">
                        < img src={left} class="testimony_body_writeup_left"/>
                        < img src={right} class="testimony_body_writeup_right"/>
                        <img src={pic} class="testimony_body_writeup_pic"/>
                    </div>
                </div>
            </div>
        </div>
